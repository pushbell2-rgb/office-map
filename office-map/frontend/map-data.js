...
export const CORRIDORS = [
  // 상단 수직 복도: P4(x=26.3) 우측 ~ T/P 구역 → 메인 복도 합류
  { id: 'COR-V1', x: 26.3, z:  0.0, w:  6.5, d: 22.0 },
  // 메인 수평 복도: E5/M16/M15 하단(z≈25.5) ~ M24/M22 상단(z≈30)
  { id: 'COR-H1', x:  0.0, z: 25.5, w: 94.5, d:  4.5 },
  // 좌측 하단 수직 복도: S2~S4 우측을 따라 아래로
  { id: 'COR-V2', x:  0.0, z: 30.0, w:  9.0, d: 42.0 },
  // 라운지2 우측 수직 복도: LOUNGE-2(x=47.4) 우측 ~ 하단 연결
  { id: 'COR-V3', x: 47.4, z: 28.5, w:  7.0, d: 34.5 },
  // 하단 수평 연결 복도: E4/E3/E2/M13 아래
